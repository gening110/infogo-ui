...
/* 改变 icon 字体路径变量，必需 */
$--font-path: '~infogo-ui/lib/theme-chalk/fonts';

@import "~infogo-ui/packages/theme-chalk/src/index";
```

之后，在项目的入口文件中，直接引入以上样式文件即可（无需引入 Element 编译好的 CSS 文件）：
```JS
import Vue from 'vue'
import Element from 'infogo-ui'
...
import ElementUI from 'infogo-ui'
import Vue from 'vue'
