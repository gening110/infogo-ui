...
<el-drawer
  ...
  :visible.sync="dialog"
  direction="rtl"
  custom-class="demo-drawer-form"
  ref="drawer"
  size="470px"
  >
  <div class="demo-drawer__content">
    <el-form :model="form" ref="ruleForm" label-position="top" class="drawer-form" @submit.native.prevent>
      ...
      <div class="demo-drawer__footer bd-t">
        <el-button plain @click="resetForm('ruleForm')">重置</el-button>
        <el-button type="primary" plain light @click="cancelForm">取消</el-button>
        <el-button type="primary" native-type="submit" :loading="loading" @click="$refs.drawer.closeDrawer()">{{ loading ? '提交中 ...' : '确定' }}</el-button>
    </div>
    </el-form>
  </div>
</el-drawer>
