...
<div style="margin-top: 15px;">
  <el-input placeholder="请输入内容" v-model="input3" class="input-with-select">
    ...
    <template slot="append">
      ...
      <el-option label=".jp" value="3"></el-option>
      <el-option label=".org" value="4"></el-option>
    </el-select>
    </template>
  </el-input>
</div>
...
<style>
  ...
  .input-with-select .el-input-group__append .el-input{
    width: 85px;
  }
</style>
<script>
...
:::demo 可通过 `size` 属性指定输入框的尺寸，除了默认的大小(40px)外，还提供了 medium(36px)、small(32px) 和 mini(24px) 三种尺寸。
```html
...
<script>
  export default {
    ...
    methods: {
      ...
      loadAll() {
        return [
          { "value": "三", "address": "长宁区新渔路1444号" },
          { "value": "三全", "address": "长宁区新渔路14号" },
          { "value": "三全鲜", "address": "长宁区新渔路1441号" },
          { "value": "三全鲜食", "address": "长宁区新渔路1442号" },
