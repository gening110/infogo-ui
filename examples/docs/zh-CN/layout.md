...
<el-row>
  <el-col :span="16"><div class="grid-content bg-purple-dark">66.66%</div></el-col>
  <el-col :span="8"><div class="grid-content bg-purple-light">33.33%</div></el-col>
</el-row>
<el-row>
...
<el-row>
  <el-col :span="8"><div class="grid-content bg-purple">33.33%</div></el-col>
  <el-col :span="8"><div class="grid-content bg-purple-light">33.33%</div></el-col>
  <el-col :span="8"><div class="grid-content bg-purple">33.33%</div></el-col>
</el-row>
<el-row>
...
<el-row>
  ...
  <el-col :span="4"><div class="grid-content bg-purple-light">20%</div></el-col>
  <el-col :span="4"><div class="grid-content bg-purple">20%</div></el-col>
  <el-col :span="4"><div class="grid-content bg-purple-light">20%</div></el-col>
  <el-col :span="4"><div class="grid-content bg-purple">20%</div></el-col>
  <el-col :span="4"><div class="grid-content bg-purple-light">20%</div></el-col>
...
```js
import 'infogo-ui/lib/theme-chalk/display.css';
```
