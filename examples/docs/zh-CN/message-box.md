...
```html
<template>
  <el-button plan @click="open('success')">success</el-button>
  <el-button plan @click="open('info')">info</el-button>
  <el-button plan @click="open('warning')">warning</el-button>
  <el-button plan @click="open('error')">error</el-button>
</template>
...
```javascript
import { MessageBox } from 'infogo-ui';
```
...
| showClose | MessageBox 是否显示右上角关闭按钮 | boolean | — | false |
