...
<template>
  <el-popover
    ...
    <el-button plain slot="reference">hover 激活</el-button>
  </el-popover>
  ...
  <el-popover
    ...
    trigger="click"
    content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。">
    <el-button plain slot="reference">click 激活</el-button>
  </el-popover>
  ...
  <el-button plain v-popover:popover>focus 激活</el-button>
  ...
  <el-popover
    ...
    content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。"
    v-model="visible">
    <el-button plain slot="reference" @click="visible = !visible">手动激活</el-button>
  </el-popover>
</template>
