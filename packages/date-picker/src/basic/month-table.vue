...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'infogo-ui/src/utils/date-util';
  import { hasClass } from 'infogo-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'infogo-ui/src/utils/util';
