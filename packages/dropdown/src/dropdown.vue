<script>
  ...
  import ElButtonGroup from 'infogo-ui/packages/button-group';
  import { generateId } from 'infogo-ui/src/utils/util';
    ...
    render(h) {
      ...
      if (splitButton) {
        triggerElm = <el-button-group>
          <el-button type={type} plain light size={dropdownSize} nativeOn-click={handleMainButtonClick} disabled={disabled}>
            {this.$slots.default}
          </el-button>
          <el-button ref="trigger" type={type} plain light size={dropdownSize} class="el-dropdown__caret-button" disabled={disabled}>
            <i class="el-dropdown__icon el-icon-more"></i>
          </el-button>
        </el-button-group>;
      } else {
